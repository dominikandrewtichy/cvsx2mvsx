...
def empiar_10070_mesh(builder: Root) -> Root:
    with open("static/cvsx/unzipped/empiar-10070/annotations.json") as f:
        json_string = f.read()
    ...
    for segment_annotation in annotations["segment_annotations"]:
        ...
        uri = f"static/cvsx/unzipped/empiar-10070/{filename}"
